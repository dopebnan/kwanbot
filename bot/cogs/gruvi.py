...
class Gruvi(commands.Cog, name="gruvi"):
    ...
    def search_yt(self, item):
        with ytdl(self.YDL_OPTS) as ytdown:
            ...
            except ytdl_errors.DownloadError:
                return False
    ...
    async def inactivity(self, ctx):
        ...
        if self.is_playing is False:
            ...
            embed = discord.Embed(title="Inactivity", description="You really invited me to do nothing?", color=0xd11f45)
    ...
    async def play(self, context, *args):
        ...
        if vc is None:
            ...
            if isinstance(song, bool):
                raise ConnectionError("video is age-restricted, or is a livestream")
            else:
