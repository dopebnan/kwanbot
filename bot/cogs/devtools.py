...
class DevTools(commands.Cog, name="Developer Tools", description="Commands for the admins/bot devs"):
    ...
    async def cog_check(self, ctx):
        ...
        if dev_role not in ctx.author.roles:
            embed = discord.Embed(
                title="You can't use DevTools.",
                description="You don't have dev perms.",
